...
extension FetchedResultsController {
    ...
    public var sections: [FetchedResultsSectionInfo<T>] {
        if let underlyingSections = self.underlyingFetchedResultsController.sections{
...
private class FecthedResultsControllerDelegate: NSObject, NSFetchedResultsControllerDelegate {
   ...
   @objc func controller(controller: NSFetchedResultsController, didChangeObject anObject: NSManagedObject, atIndexPath indexPath: NSIndexPath?, forChangeType type: NSFetchedResultsChangeType, newIndexPath: NSIndexPath?) {
        switch type {
        case .Insert:
            self.fetchedResultsController.didInsertEntityClosure?(anObject , newIndexPath!)
            
        case .Delete:
            self.fetchedResultsController.didDeleteEntityClosure?(anObject, indexPath!)
            
        case .Update:
            self.fetchedResultsController.didUpdateEntityClosure?(anObject, indexPath!)
            
        case .Move:
            self.fetchedResultsController.didMoveEntityClosure?(anObject, indexPath!, newIndexPath!)

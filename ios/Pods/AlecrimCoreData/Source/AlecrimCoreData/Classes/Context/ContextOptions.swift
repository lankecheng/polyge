...
public final class ContextOptions {
    ...
    public static var stringComparisonPredicateOptions:NSComparisonPredicateOptions = ([NSComparisonPredicateOptions.CaseInsensitivePredicateOption,NSComparisonPredicateOptions.DiacriticInsensitivePredicateOption])
    ...
    internal func fillEmptyOptions(customConfiguration: Bool = false) {
        ...
        if self.managedObjectModelName == nil {
            if let infoDictionary = self.mainBundle.infoDictionary {
                self.managedObjectModelName = infoDictionary[String(kCFBundleNameKey)] as? String
            }
        }
        ...
        if let groupIdentifier = self.applicationGroupIdentifier {
            ...
            persistentStoreContainerURL = urls.last
        }
        ...
        if let containerURL = persistentStoreContainerURL {
            ...
            if !fileManager.fileExistsAtPath(containerURL.path!) {
                do{
                    try fileManager.createDirectoryAtURL(containerURL, withIntermediateDirectories: true, attributes: nil)
                }catch{

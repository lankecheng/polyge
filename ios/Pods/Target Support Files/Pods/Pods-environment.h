...
#define COCOAPODS_VERSION_MINOR_APIKit 8
#define COCOAPODS_VERSION_PATCH_APIKit 0
...
#define COCOAPODS_VERSION_PATCH_Async 1
...
#define COCOAPODS_VERSION_PATCH_Starscream 4
